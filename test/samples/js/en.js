(function(scope) {
  ...
  mm.catalog = mm.catalog || {"things\u0004one book":"one book","things\u0004{n} books":"{n} books","dog":"dog\ndog","Testing\nKeep Testing":"Testing","Password":"Password","Rules":"Rules","Username":"Username","Egg":"Egg","Eggs":"Eggs","weekday\u0004Sunday":"Sunday","weekday\u0004Sundays":"Sundays","fruit\u0004orange":"orange","Testing %(module)s":"Testing %(module)s"};
